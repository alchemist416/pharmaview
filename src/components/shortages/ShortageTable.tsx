      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs">
          ...
          <tbody>
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={5} className="text-center py-8 text-muted font-mono">
                  No shortages found
                </td>
              </tr>
            ) : (
                ...
                >
                  ...
                  <td className="py-2.5 px-3">
                    <div className="flex items-center gap-2">
                      <button className="flex items-center gap-1 text-[10px] font-mono text-accent-blue hover:text-accent-blue/80 transition-colors">
                        <MapPin size={10} /> Map
                      </button>
                      <button className="flex items-center gap-1 text-[10px] font-mono text-accent-amber hover:text-accent-amber/80 transition-colors">
                        <Bell size={10} /> Alert
                      </button>
                    </div>
                  </td>
